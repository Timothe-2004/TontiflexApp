    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_frais_creation', models.ForeignKey(blank=True, help_text='Transaction KKiaPay pour les frais de création', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='comptes_epargne_crees', to='payments.kkiapaytransaction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_kkiapay', models.OneToOneField(help_text='Transaction KKiaPay associée', on_delete=django.db.models.deletion.CASCADE, related_name='transaction_epargne', to='payments.kkiapaytransaction')),
            ],
            options={
